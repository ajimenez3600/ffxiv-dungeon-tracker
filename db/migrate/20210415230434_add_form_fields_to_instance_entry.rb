class AddFormFieldsToInstanceEntry < ActiveRecord::Migration[6.1]
  def change
    ...
    add_column :instance_entries, :start_level, :number
    add_column :instance_entries, :start_xp, :number
    ...
    add_column :instance_entries, :finish_level, :number
    add_column :instance_entries, :finish_xp, :number
    add_column :instance_entries, :xp_bonus, :number
    add_column :instance_entries, :roulette_bonus, :number
    add_column :instance_entries, :new_player_bonus, :number
    add_column :instance_entries, :role_in_need_bonus, :number
    add_column :instance_entries, :other_bonus, :number
    add_column :instance_entries, :commends, :number
